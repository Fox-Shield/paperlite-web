...
<template>
    <div class="min-h-screen bg-gray-50">
        ...
        >
            <div
                class="max-w-5xl mx-auto px-6 h-14
            ...
            >
                ...
                <router-link
                    to="/intake-forms/new"
                    class="px-3 py-1.5 bg-gray-900 text-white text-sm
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-gray-100">
                            <th
                                class="text-left px-4 py-3 text-xs font-medium
                                    text-gray-500"
                            >
                                Title
                            </th>
