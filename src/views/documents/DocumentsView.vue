        ...
        <table class="docs-table">
          ...
          <tbody>
            <tr v-for="doc in documentStore.documents" :key="doc.id">
              ...
              <td><span class="type-badge">{{ doc.type || 'PDF' }}</span></td>
              <td class="muted">{{ formatSize(doc.size) }}</td>
              <td class="muted">{{ formatDate(doc.updatedAt || doc.createdAt) }}</td>
              <td>
                <div class="row-actions">
                  ...
                  <button class="action-btn danger" title="Delete" disabled>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
